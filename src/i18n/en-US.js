export default {
    ...
    app: {
        ...
        search_provider: 'Default Search',
        provider_google: 'Google (Redirect)',
        provider_osm: 'OSM (Built-in)',
        backend_url: 'Google Map URL parser',
        backend_key: 'API Key',
        configure_backend: 'Configure URL parser',
    ...
    planner: {
        ...
        day_n: 'Day {n}',
        plan_default_name: 'Plan {n}',
        plan_add: 'Add plan',
        plan_rename: 'Rename',
        plan_duplicate: 'Duplicate',
        plan_delete: 'Delete plan',
        plan_delete_confirm: 'Delete this plan?',
        plan_save_to_pool: 'Save to pool',
        saved_to_pool: 'Saved to plan pool',
        pool_title: 'Plan Pool',
        pool_open: 'Plan Pool',
        pool_save_current: 'Save current plan',
        pool_empty: 'The pool is empty. Save day plans here to reuse them.',
        pool_copy_to_days: 'Copy to days',
        pool_copy_success: 'Copied to {count} day(s)',
        pool_remove: 'Remove from pool',
        pool_remove_confirm: 'Remove this plan from the pool?',
